                                ...
                                <div class="row text-center">
                                    <div class="col flex-grow cols-sm-8">
                                        ...
                                        <div class="flex flex-row flex-wrap justify-center">
                                            <AuthButton class="m-4" :label="$t('submit')" :tooltip="$t('login')"
                                                :is-loading="isLoading" @clicked="$emit('login', { username, password })" />
                                            <GoogleAuthButton class="m-4" :tooltip="$t('login')" />
                                        </div>
                                        <hr />
                                        <AuthButton class="m-4" :label="$t('accountRecoveryHere')"
                                            :tooltip="$t('accountRecoveryHere')" :is-loading="isLoading"
